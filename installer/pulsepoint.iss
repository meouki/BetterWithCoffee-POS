...
; 1. Ensure the Node.js MSI (node-v24.14.0-x64.msi) is in this folder.
; 2. Ensure your frontend is built (`npm run build` in the frontend folder).
; 3. Open this .iss file in Inno Setup Compiler and click "Compile".
; -----------------------------------------------------------------------------
